...
Connections2Triples.prototype._pushDelay = function (connectionId, delay, delay_reason, type) {
  ...
  this.push({
    ...
    predicate :'http://semweb.mmlab.be/ns/linkedconnectionsmeta#' + type + 'Delay',
    object : delayId
  });
  this.push({
    subject: delayId,
    predicate :'http://www.w3.org/1999/02/22-rdf-syntax-ns#type',
    object: 'http://semweb.mmlab.be/ns/linkedconnectionsmeta#Delay'
  });
  this.push({
    subject: delayId,
    predicate :'http://semweb.mmlab.be/ns/linkedconnectionsmeta#delayValue',
    object: "\"" + delay + "\""
  });
  this.push({
    subject: delayId,
    predicate :'http://semweb.mmlab.be/ns/linkedconnectionsmeta#delayReason',
    object: delay_reason
  });
};
