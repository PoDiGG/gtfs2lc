  ...
  if (!program.format || program.format === "json") {
    ...
    var context = {
      '@context' : {
        ...
        lcd: 'http://semweb.mmlab.be/ns/linked-connections-delay#',
    ...
    if (program.format === 'ntriples') {
      ...
      stream = stream.pipe(new N3.StreamWriter({ prefixes: { lc: 'http://semweb.mmlab.be/ns/linkedconnections#', lcd: 'http://semweb.mmlab.be/ns/linked-connections-delay#', td: 'http://purl.org/td/transportdisruption#', gtfs : 'http://vocab.gtfs.org/terms#', xsd: 'http://www.w3.org/2001/XMLSchema#' } }));
    }
